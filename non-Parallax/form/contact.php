...
if ((isset($_POST['people'])) && (strlen(trim($_POST['people'])) > 0)) {
$people = stripslashes(strip_tags($_POST['people']));
} else {$people = 'No number of people entered';}
...
} else {$datetimepicker = 'No Date & Time entered';}
...
$body = "Below are the details submitted by the user on your website.<br><br> Name: 
			 ".$_POST['name']."<br><br>Email: ".$_POST['email']."<br><br>Phone: ".$_POST['phone']."<br><br>No. of People: ".$_POST['people']."
